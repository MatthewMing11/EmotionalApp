...
clean('isear_data.txt','isear_processed.csv',1,2)

input_file_n = open("labelled_neg.txt", encoding='ISO-8859-1')
input_file_p = open('labelled_pos.txt',encoding='ISO-8859-1')
