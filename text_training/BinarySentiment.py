...
dataframe = pd.read_csv('../text_datasets/posneg_processed.csv', names=names, encoding = "ISO-8859-1")
...
model.save('../text_models/binary_model.h5')  # creates a HDF5 file 'my_model.h5'
